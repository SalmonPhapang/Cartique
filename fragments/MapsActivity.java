...
import com.car.cartique.app.CircularNetworkImageView;
import com.car.cartique.model.Client;
import com.car.cartique.model.Location;
            ...
            if (ActivityCompat.checkSelfPermission(getContext(), Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        GenericTypeIndicator<Map<String, List<Client>>> genericTypeIndicator = new GenericTypeIndicator<Map<String, List<Client>>>() {
                        };
                        Map<String, List<Client>> clients = dataSnapshot.getValue(genericTypeIndicator);

                        for (String key : clients.keySet()) {

                            List<Client> clientList = clients.get(key);
